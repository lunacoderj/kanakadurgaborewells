      ...
      <div className="max-w-[1400px] mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          >
            ...
            <Image 
              src="/images/borewell_rig_1.png" 
              alt="Kanakadurga High-Performance Rig" 
              width={1200}
              height={800}
              className="w-full h-auto object-contain group-hover:scale-105 transition-transform duration-1000 ease-in-out" 
            />
